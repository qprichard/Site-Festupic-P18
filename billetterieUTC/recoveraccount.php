        ...
        if (isset($_POST['email'])) {
          ...
          if ($query->rowCount() == 0)
            ...
            elseif ($query->rowCount() == 0) {
              ...
              if ($query->rowCount() == 0) {
                $url = "http://".$_SERVER['HTTP_HOST']."/billetterieUTC/reinitpassword.php?email=".$_POST['email']."&token=".$token;
                ...
                mail($_POST['email'], 'Réinitialisation du mot de passe de votre compte billetterieUTC',
"Bonjour,<br />
<br />
...
L'équipe de billetterieUTC.", $headers);
              ...
              if (time() - $data['creation_date'] < 2 * 60 * 60)
                ...
                mail($_POST['email'], 'Confirmation de création de compte: billetterieUTC',
"Bonjour,<br />
<br />
...
L'équipe de billetterieUTC.", $headers);
        ...
        if (!isset($success)) {
          ?>
            ...
            <div>
              <a href="https://www.facebook.com/festu.pic">Nous contacter</a>
            </div>
          <?php
        }
      ?>
