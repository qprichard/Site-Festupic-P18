  ...
  <div class="container">
    <form name="form_connection" method="post" action='./connect.php' style="text-align:center">
      ...
      <div style="padding-top: 25px">
        <input id='cas-button' class="button form-button" onClick="window.location.href='http://cas.utc.fr/cas/login?service=http://<?php echo $_SERVER['HTTP_HOST'], $_SERVER['REQUEST_URI']; ?>'" value="JE SUIS ETUDIANT(E) UTC/ESCOM" style="border-radius: 5px; margin-right: 10px" type="button">
