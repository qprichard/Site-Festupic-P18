          ...
          elseif ($_POST['password'] == $_POST['password_conf']) {
            ...
            if ($query->rowCount() == 0) {
              ...
              if ($query->rowCount() != 0) {
                ...
                $url = 'http://'.$_SERVER['HTTP_HOST']."/billetterieUTC/connect.php?email=".$data['email']."&token=".$token;
                ...
                mail($data['email'], 'Confirmation de création de compte Tremplin: billetterieUTC',
        ...
        if (!isset($success)) {
          ?>
            ...
            <div style="padding-top: 25px">
              ...
              <input class="button form-button" onClick="window.location.href='/billetterieUTC/register.php';" value="JE NE SUIS PAS COTISANT TREMPLIN" style="border-radius: 5px; margin-right: 10px" type="button"><br />
