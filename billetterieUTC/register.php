        ...
        if (isset($_POST['email']) && isset($_POST['password']) && isset($_POST['password_conf']) && isset($_POST['lastname']) && isset($_POST['firstname']) && isset($_POST['birthdate'])) {
          ...
          elseif ($_POST['password'] == $_POST['password_conf']) {
            ...
            if ($query->rowCount() == 0) {
              ...
              $url = 'http://'.$_SERVER['HTTP_HOST']."/billetterieUTC/connect.php?email=".$_POST['email']."&token=".$token;
              ...
              mail($_POST['email'], 'Confirmation de création de compte: billetterieUTC (Compiègne en Lumière)',
...
<br />
A bientôt,<br />
L'équipe de billetterieUTC.", $headers);
        ...
        if (!isset($success)) {
          ?>
            ...
            <div style="padding-top: 25px">
              <input id='cas-button' class="button form-button" onClick="window.location.href='http://cas.utc.fr/cas/login?service=http://<?php echo $_SERVER['HTTP_HOST'], '/billetterieUTC/connect.php'; ?>'" value="JE SUIS ETUDIANT(E) UTC/ESCOM" style="border-radius: 5px; margin-right: 10px" type="button"><br />
              <input class="button form-button" onClick="window.location.href='/billetterieUTC/registerTremplin.php';" value="JE SUIS COTISANT TREMPLIN" style="border-radius: 5px; margin-right: 10px" type="button"><br />
