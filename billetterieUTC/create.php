    ...
    elseif (isset($_POST['lastname']) && isset($_POST['firstname']) && isset($_POST['email']) && isset($_POST['birthdate'])) {
      ...
      foreach ($emails as $key => $email) {
        ...
        if ($query->rowCount() == 0) {
          ...
          $url = "https://".$_SERVER['HTTP_HOST']."/billetterieUTC/reinitpassword.php?email=".$email."&token=".$token;
          ...
          mail($email, 'Création automatique de votre compte billetterieUTC et réservation de votre billet',
"Bonjour,<br />
<br />
